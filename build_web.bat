...
if "%BUILD_MODE%"=="serve" (
    ...
    echo.
    "%PY%" -m pygbag --title "Busakawa Alien Battle 2" --width 1300 --height 808 --template web/busakawa.tmpl .
    exit /b 0
)
...
echo.
    "%PY%" -m pygbag --build --title "Busakawa Alien Battle 2" --width 1300 --height 808 --template web/busakawa.tmpl --archive .
